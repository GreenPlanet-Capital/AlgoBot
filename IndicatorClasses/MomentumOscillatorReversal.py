...
'''
'''
Inputs: dataframe_input, lookback_period, sensitivity = 1.8, absolute_sensitivity = 50
...
class MomentumOscillatorReversal:

    def __init__(self, dataframe_input, lookback_period, sensitivity = 1.8, absolute_sensitivity = 50):
...
#######################
    ...
    def train_test(self, indic_name = 'MOMOSC REVERSAL', stop_percent = 0.05):
        df = self.dataframe_input
