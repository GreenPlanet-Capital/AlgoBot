...
class Engine1:
    ...
    def long_short_singlelexicon(self, df_input, lookback):
        ...
        vol_osc_weightedSignal = generate_weightedList(vol_osc_liveSignal_list)
        vol_osc_weight = weight_adjust(vol_osc_weight)
        ...
        fish_trans_weight = fish_trans_weight/total_weight
        ...
        final_reading = (
            ...
            fish_trans_weight * fish_trans_weightedSignal + 
    ...
    def generate_longShortStrength(self, df_input):
        ...
        """
        lkbk_gen = self.lookback_lexicon()
        strength = 0
        for i in lkbk_gen:
            strength += self.long_short_singlelexicon(df_input, i)
