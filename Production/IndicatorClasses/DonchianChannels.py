...
Naming Convention of DataFrame Columns: 
    Indicator Generated DataFrame head: 
        Mid-channel: DONCHMID + lookback_period
        Upper-Channel: DONCHUP + lookback_period
        Lower-Channel: DONCHDOWN + lookback_period

    Signal Generated DataFrame head: DONCH SIGNAL + lookback_period
    Signum Generated DataFrame head: DONCH SIGNUM + lookback_period
...
class DonchianChannels:
    ...
    def __init__(self, dataframe_input, lookback_period, sensitivity = 0.95, absolute_sensitivity = 50):
...
#######################
    ...
    def indicator_generator(self):
        ...
        indic_columnhead_down = 'DONCHDOWN ' + str(n)
...
#######################
    ...
    def signal_generation(self, indic_name = 'DONCH'):
        df = self.dataframe_input
...
#######################
    ...
    def train_test(self, indic_name = 'DONCH', stop_percent = 0.05):
        df = self.dataframe_input
