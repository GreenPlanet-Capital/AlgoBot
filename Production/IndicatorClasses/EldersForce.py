...
#######################
    ...
    def indicator_generator(self):
        ...
        df_indicators["EMA " + indic_columnhead] = ema(eld_list, n - 2)
...
#######################
    ...
    def signal_generation(self, indic_name = 'EMA ELDERS FORCE'):
...
#######################
    ...
    def train_test(self, indic_name = 'EMA ELDERS FORCE', stop_percent = 0.05):
        df = self.dataframe_input
