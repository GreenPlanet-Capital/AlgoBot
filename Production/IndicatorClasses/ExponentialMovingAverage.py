...
'''
'''
Inputs: dataframe_input, lookback_period1, lookback_period2, sensitivity = , absolute_sensitivity = 
...
#######################
    ...
    def signal_generation(self, indic_name = 'EMA'):
...
#######################
    ...
    def train_test(self, stop_percent = 0.05):
        ...
        indic_name = 'OSC EMA ' + str(self.lookback_period1) + ' EMA'
