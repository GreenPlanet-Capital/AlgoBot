...
Naming Convention of DataFrame Columns: 
    Indicator Generated DataFrame head: OSC FISH TRANS + lookback_period
    Signal Generated DataFrame head: OSC FISH TRANS SIGNAL + lookback_period
    Signum Generated DataFrame head: OSC FISH TRANS SIGNUM + lookback_period
...
#######################
    ...
    def signal_generation(self, indic_name = 'OSC FISH TRANS'):
...
#######################
    ...
    def train_test(self, indic_name = 'OSC FISH TRANS', stop_percent = 0.05):
        df = self.dataframe_input
