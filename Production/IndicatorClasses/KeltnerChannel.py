...
Naming Convention of DataFrame Columns: 
    Indicator Generated DataFrame head: 
        MID-CHANNEL: KELT MIDCHANNEL + lookback_period
        UP-CHANNEL: KELT UPCHANNEL + lookback_period
        DOWN-CHANNEL: KELT DOWNCHANNEL + lookback_period
    Signal Generated DataFrame head: KELT SIGNAL + lookback_period
    Signum Generated DataFrame head: KELT SIGNUM + lookback_period
...
Usage Notes:
* Moves above or below the channel lines warrant attention because they are relatively rare.
...
* Relative lookback period based slopes may be used to detect consolidation in a trend,
or breakout toward a certain direction.
...
'''
'''
Inputs: dataframe_input, lookback_period, sensitivity = 0.7, absolute_sensitivity = 50
...
class KeltnerChannel:
    ...
    def __init__(self, dataframe_input, lookback_period, sensitivity = 0.7, absolute_sensitivity = 50):
...
#######################
    ...
    def signal_generation(self, indic_name = 'KELT'):
        df = self.dataframe_input
...
#######################
    ...
    def train_test(self, indic_name = 'KELT', stop_percent = 0.05):
        df = self.dataframe_input
