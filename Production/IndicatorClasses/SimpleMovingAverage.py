...
Naming Convention of DataFrame Columns: 
    Indicator Generated DataFrame head: OSC SMA + lookback_period1 + SMA + lookback_period2 
    Signal Generated DataFrame head: OSC SMA + lookback_period1 + SMA SIGNAL + lookback_period2
    Signum Generated DataFrame head: OSC SMA + lookback_period1 + SMA SIGNUM + lookback_period2
...
Usage Notes: Moving Average. Use Oscillator Generator
...
#######################
    ...
    def train_test(self, stop_percent = 0.05):
        ...
        indic_name = 'OSC SMA ' + str(self.lookback_period1) + ' SMA'
