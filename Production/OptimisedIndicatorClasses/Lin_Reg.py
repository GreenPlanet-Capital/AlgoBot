...
class Lin_Reg:
    ...
    def __init__(self, price_array, lookback):
        self.price_array = price_array
        self.lookback = lookback 
        self.linreg_array = np.array([])
    ...
    def linreg(self):
        ...
        self.linreg_array = out_array

    def signal_generation(self):
        linreg_array = self.linreg_array
    ...
    def graphing(self):
        ...
        figure(figsize=(plot_width, plot_length))
        ax2 = plt.subplot()
        plt.plot(np.arange(linreg_array .size), linreg_array, color = 'darkgreen')
    ...
    def diagnostics(self):
        ...
        print("Indicator Name: Linear Regression Oscillator")
...
def main():
    ...
    indic_obj = Lin_Reg(price_list, 5)
    x = indic_obj.run()
