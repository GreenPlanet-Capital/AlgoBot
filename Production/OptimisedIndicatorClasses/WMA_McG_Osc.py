...
class WMA_McG_Osc:
    ...
    def wma_mcg_osc_gen(self):
        ...
        out_arr = np.subtract(wma(price_array, short_lookback)[long_lookback:], mcg(price_array, long_lookback)[long_lookback:])
    ...
    def diagnostics(self):
        ...
        print("Indicator Name: Weighted Moving Average/McGinley Dynamic Oscillator")
...
def main():
    ...
    indic_obj = WMA_McG_Osc(price_list, 5, 8)
    x = indic_obj.run()
